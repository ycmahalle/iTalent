...
<body>
    ...
    <form class="form-container col-lg-4 col-md-3 col-sm-7" action="{{url('/register-employee')}}" method="POST">
        @csrf
        <h1 class="text-white" style="text-align: center;font-family:Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;  font-size:3rem"> Register
            </h1>
            @if ($errors->any())
            ...
            <div class="form-group" style="margin-top:10vh;">
                <input type="text" class="form-control inn rounded-pill  px-4" name="name" placeholder="Enter Full Name">
            </div>
            ...
            <div class="form-group">
                <input type="password" class="form-control inn rounded-pill   px-4" name="password_confirmation" placeholder="**********" >
            </div>
            <div class="form-group text-center"> Click to<a href="/" class="text-white">Login</a></div>

            <div class="form-group text-center">
                <input type="submit" style="border:2px solid" class="form-control btn btn-pill rounded-pill btn-outline-dark opacity-90 w-50" name="Login" value="Register">
            </div>
    </form>
